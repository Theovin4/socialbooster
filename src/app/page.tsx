...
export const metadata: Metadata = {
  ...
  description: "Discover Instagram, TikTok, YouTube and Facebook marketing services with secure card, bank and cryptocurrency payments plus live order tracking.",
  alternates: { canonical: "/", languages: { "en-NG": "/", "x-default": "/" } },
  openGraph: { title: "Social Media Marketing Services in Nigeria", description: "Professional social media services, flexible payments and accountable order tracking for Nigeria and Africa.", url: "/" },
};
...
const benefits = [
  { title: "Clear pricing", text: "See prices, limits and support options before ordering." },
  { title: "Flexible payments", text: "Pay securely by card, bank transfer or supported cryptocurrencies." },
  { title: "Live order tracking", text: "Track progress and manage support from your dashboard." },
];
const faqs = [
  { question: "How can I fund my account?", answer: "You can use the available card, bank-transfer or supported cryptocurrency options shown in your wallet. Every payment is verified before your balance is credited." },
  { question: "Can customers outside Nigeria use Social Booster?", answer: "Customers in supported African countries can create an account and browse services. Available payment methods depend on location and the options shown at checkout." },
...
export default function Home() {
  ...
  return <><SiteHeader /><main>
    ...
    <section className="shell" style={{ padding: "100px 0 70px", textAlign: "center" }}>
      ...
      <h1 style={{ fontSize: "clamp(3rem,8vw,6.8rem)", lineHeight: .93, letterSpacing: "-.065em", maxWidth: 1100, margin: "22px auto" }}>Build a stronger<br />social presence <span style={{ background: "linear-gradient(90deg,#58dcff,#9d83ff)", WebkitBackgroundClip: "text", color: "transparent" }}>with confidence.</span></h1>
      <p className="muted" style={{ fontSize: "clamp(1rem,2vw,1.25rem)", lineHeight: 1.6, maxWidth: 720, margin: "24px auto 32px" }}>Professional social media services, flexible payments and live order tracking in one secure platform.</p>
    ...
    <section className="shell" style={{ padding: "90px 0 20px", textAlign: "center" }}><h2 style={{ fontSize: "clamp(2.2rem,5vw,4rem)", letterSpacing: "-.04em" }}>Ready to begin?</h2><p className="muted">Compare services and see the exact charge before ordering.</p><Link className="btn primary" href="/register" style={{ marginTop: 20 }}>Create account</Link></section>
  </main><SiteFooter /></>;
}
