...
const benefits = [
  ...
  { title: "Verified payments", text: "Funds are credited only after payment confirmation." },
...
export default function Home() {
  ...
  return <><SiteHeader /><main>
    ...
    <section className="shell" style={{ padding: "100px 0 70px", textAlign: "center" }}>
      ...
      <p className="muted" style={{ fontSize: "clamp(1rem,2vw,1.25rem)", lineHeight: 1.6, maxWidth: 720, margin: "24px auto 32px" }}>Social media services with secure payments and live order tracking.</p>
