...
export default async function ServiceDetails({ params }: { params: Promise<{ id: string }> }) {
  ...
  const sellingRateMinor = service.sellingCurrency === "NGN" ? service.sellingRateMinor : Number(convertMinor(BigInt(service.sellingRateMinor), configuredUsdToNgnRateMicros()));
