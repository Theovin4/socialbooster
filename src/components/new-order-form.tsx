...
export function NewOrderForm({ services, selectedId, action }: { services: OrderService[]; selectedId?: string; action: (formData: FormData) => void | Promise<void> }) {
  ...
  return <div className="glass card"><form action={action} className="form-grid">
