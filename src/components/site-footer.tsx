...
const links = ["services", "pricing", "api-docs", "how-it-works", "africa", "blog", "about", "editorial-policy", "contact", "faq", "terms", "privacy", "refund-policy", "acceptable-use", "cookie-policy"];
